    ...
    return (
      ...
      <div class="-mt-px flex divide-x divide-gray-200">
        ...
        <div class="-ml-px w-0 flex-1 flex">
          <p class="tel:+1-202-555-0170" class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-yellow-600 font-medium border border-transparent rounded-br-lg hover:text-blue-900">
...
<ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols min-h-full">
